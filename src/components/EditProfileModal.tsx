  ...
  return (
    <Modal open={open} onClose={onClose} title="Modifier le profil">
      <div className="flex flex-col items-center mb-5">
        <div className="relative">
          ...
          <button
            ...
            disabled={uploading}
            className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-[#6600FF] flex items-center justify-center shadow-lg active:scale-90 transition-transform disabled:opacity-50"
          >
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="glass-surface w-full px-4 py-3 rounded-2xl text-sm font-medium text-[#1A1A2E] focus:outline-none focus:border-[#6600FF] focus:ring-2 focus:ring-[#6600FF]/10 transition-all"
          />
        </div>
        <div>
          ...
          <textarea
            ...
            rows={3}
            maxLength={200}
            className="glass-surface w-full px-4 py-3 rounded-2xl text-sm text-[#1A1A2E] focus:outline-none focus:border-[#6600FF] focus:ring-2 focus:ring-[#6600FF]/10 transition-all resize-none"
          />
        </div>
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              className="glass-surface w-full px-4 py-3 rounded-2xl text-sm font-medium text-[#1A1A2E] focus:outline-none focus:border-[#6600FF] transition-all"
            >
              {CITIES.map((c) => (
          ...
          <div>
            ...
            <div className="glass-surface px-4 py-3 rounded-2xl text-sm font-medium text-[#1A1A2E] flex items-center gap-2">
      ...
      <div className="flex gap-3 mt-6">
        <button
          onClick={onClose}
          className="glass-surface flex-1 py-3 rounded-full text-gray-600 text-sm font-semibold flex items-center justify-center gap-1.5 active:scale-95 transition-transform"
        >
        ...
        <button
          ...
          className="flex-1 py-3 rounded-full bg-[#6600FF] text-white text-sm font-bold flex items-center justify-center gap-1.5 active:scale-95 transition-transform disabled:opacity-40 shadow-lg shadow-[#6600FF]/30"
        >
