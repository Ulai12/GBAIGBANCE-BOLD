  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-0 flex items-center justify-between p-5">
        ...
        <button type="button" aria-label="Ajouter aux favoris" onClick={(eventClick) => eventClick.stopPropagation()} className="flex h-10 w-10 items-center justify-center rounded-full border border-white/25 bg-black/10 backdrop-blur-xl transition-transform hover:scale-105 active:scale-90">
      ...
      <div className="absolute inset-x-5 bottom-5">
        <div className="mb-3 flex flex-wrap items-center gap-2 text-xs font-semibold text-white/75">
          ...
          <span className="flex items-center gap-1"><Map className="h-3.5 w-3.5 text-[#a78dfa]" />{event.city}</span>
        </div>
