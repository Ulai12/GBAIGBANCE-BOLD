...
export const AISettingsScreen: React.FC<AISettingsScreenProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#111116] text-white flex flex-col antialiased">
      {/* Top Header */}
      <header className="sticky top-0 z-30 flex items-center justify-between px-4 py-4 bg-[#111116]/90 backdrop-blur-md border-b border-white/5">
        <button
          id="ai-settings-back-button"
          type="button"
          onClick={onBack}
          className="w-10 h-10 rounded-full flex items-center justify-center text-gray-300 hover:text-white hover:bg-white/10 active:scale-95 transition-all"
          aria-label="Retour"
        >
      ...
      {/* Main Content */}
      <div className="flex-1 max-w-xl w-full mx-auto px-4 py-6 space-y-6">
        {/* Intro Card */}
        <section className="bg-[#1C1C23] border border-white/5 rounded-3xl p-5 shadow-lg relative overflow-hidden">
          <h2 className="text-base font-extrabold text-white text-center mb-2.5 tracking-tight">
            Intelligence artificielle
          </h2>
          <p className="text-xs leading-relaxed text-zinc-300 text-center font-normal">
          ...
          <button
            ...
            type="button"
            onClick={() => setShowGuideModal(true)}
            className="mt-4 w-full py-2.5 px-4 rounded-2xl bg-[#262631] hover:bg-[#30303E] active:scale-[0.99] border border-white/5 flex items-center justify-between text-xs font-semibold text-zinc-200 transition-all group"
          >
            <div className="flex items-center gap-2.5">
              <HelpCircle className="w-4 h-4 text-zinc-400 group-hover:text-white" />
        ...
        {/* Google Gemini Card */}
        <section className="bg-[#1C1C23] border border-white/5 rounded-3xl p-5 shadow-lg space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400 font-medium">Modèle en ligne</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`relative inline-flex h-7 w-12 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden ${
                  config.enabled ? 'bg-[#34C759]' : 'bg-zinc-700'
                }`}
              >
                <span
            ...
            <div className="pt-2 space-y-3.5 animate-in fade-in duration-200">
              ...
              {isConfigured ? (
                <div
                  ...
                  className="rounded-2xl p-4 bg-[#132A1C] border border-[#238636]/40 text-[#4ADE80] flex items-start gap-3 shadow-inner"
                >
                  <CheckCircle2 className="w-4 h-4 text-[#4ADE80] shrink-0 mt-0.5" />
                  <div className="text-xs space-y-1">
                    <p className="font-extrabold text-sm tracking-tight text-[#4ADE80]">
                      Succès
                    </p>
                    <p className="text-zinc-200 leading-relaxed font-normal">
                      Pour utiliser la fonction d'intelligence artificielle, cliquez sur
                      l'Assistant IA sur l'écran d'accueil ou consultez les conseils
                      sur vos fiches d'événements.
                    </p>
                  </div>
                </div>
              ) : (
                <div className="rounded-2xl p-4 bg-amber-950/40 border border-amber-500/30 text-amber-300 flex items-start gap-3">
                  <AlertTriangle className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />
                  <div className="text-xs space-y-0.5">
                    <p className="font-bold text-amber-200">Clé API requise</p>
                    <p className="text-zinc-300 leading-relaxed">
                      Saisissez votre clé API Gemini personnelle ci-dessous pour débloquer
                      les fonctionnalités d'assistance intelligente.
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-2">
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-full py-3.5 pl-4 pr-20 rounded-2xl bg-[#121217] border border-zinc-800 text-xs font-mono text-white placeholder-zinc-500 focus:outline-hidden focus:border-[#6600FF] focus:ring-1 focus:ring-[#6600FF] transition-all"
                  />
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={isTesting}
                    className="flex-1 py-2.5 px-3 rounded-xl bg-[#262631] hover:bg-[#30303E] active:scale-[0.98] border border-white/5 text-zinc-200 text-xs font-semibold transition-all flex items-center justify-center gap-1.5 disabled:opacity-50"
                  >
                    {isTesting ? (
                      <>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full py-3 px-3.5 rounded-2xl bg-[#141419] hover:bg-[#1A1A21] border border-white/5 flex items-center justify-between text-xs font-medium text-zinc-200 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <Key className="w-4 h-4 text-zinc-400 group-hover:text-white" />
                  <span className="font-semibold text-white">Obtenir la clé API</span>
                </div>
                <ExternalLink className="w-4 h-4 text-zinc-500 group-hover:text-white" />
              </a>

              {/* Row 2: Modèle d'IA */}
              <div className="w-full py-2 px-3.5 rounded-2xl bg-[#141419] border border-white/5 flex items-center justify-between text-xs">
                <div className="flex items-center gap-3">
                  <Cpu className="w-4 h-4 text-zinc-400" />
                  <span className="font-semibold text-white">Modèle d'IA</span>
                </div>
                ...
                <div className="relative">
                  <button
                    ...
                    className="py-1.5 px-3 rounded-xl bg-[#262631] hover:bg-[#323240] text-white font-mono text-[11px] font-bold border border-white/5 flex items-center gap-1.5 transition-colors"
                  >
                  ...
                  {/* Dropdown for Model */}
                  {showModelPicker && (
                    <div className="absolute right-0 bottom-full mb-2 w-52 rounded-2xl bg-[#1E1E26] border border-zinc-700 shadow-2xl p-2 z-50 space-y-1 animate-in fade-in duration-150">
                      <div className="px-2 py-1 text-[10px] uppercase tracking-wider font-bold text-zinc-400">
                      ...
                      <button
                        ...
                        className={`w-full text-left p-2 rounded-xl text-xs flex items-center justify-between ${
                          config.model === 'gemini-2.5-flash'
                            ? 'bg-[#6600FF] text-white font-bold'
                            : 'text-zinc-300 hover:bg-white/5'
                        }`}
                      >
                        <div>
                          <p className="font-mono text-[11px]">gemini-2.5-flash</p>
                          <p className="text-[10px] opacity-80 font-sans">
                            Recommandé • Maps Grounding
                          </p>
                        </div>
                        {config.model === 'gemini-2.5-flash' && <Check className="w-3.5 h-3.5" />}
                      </button>
                      ...
                      >
                        <div>
                          <p className="font-mono text-[11px]">gemini-3.8-flash</p>
                          <p className="text-[10px] opacity-80 font-sans">
                            Ultra-rapide • Texte général
                          </p>
                        </div>
                        {config.model === 'gemini-3.8-flash' && <Check className="w-3.5 h-3.5" />}
                      </button>
                    </div>
                  )}
                </div>
              ...
              <div className="w-full py-3 px-3.5 rounded-2xl bg-[#141419] border border-white/5 flex items-center justify-between text-xs">
                <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden ${
                    config.enableMapsGrounding ? 'bg-[#34C759]' : 'bg-zinc-700'
                  }`}
                >
                  <span
              ...
              {config.apiKey && (
                <div className="pt-2 flex justify-end">
                  <button
                    type="button"
                    onClick={handleReset}
                    className="text-[11px] text-zinc-500 hover:text-rose-400 flex items-center gap-1.5 transition-colors"
                  >
      ...
      {showGuideModal && (
        ...
        >
          <div
            className="w-full max-w-md rounded-3xl bg-[#1A1A22] border border-white/10 p-6 shadow-2xl space-y-4"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between pb-2 border-b border-white/5">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#6600FF]/20 flex items-center justify-center text-[#6600FF]">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400">Obtenir une clé API gratuite</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="space-y-3 text-xs text-zinc-300 leading-relaxed">
              <div className="p-3 rounded-2xl bg-[#14141A] border border-white/5">
                <p className="font-bold text-white mb-1">1. Rendez-vous sur Google AI Studio</p>
              ...
              <div className="p-3 rounded-2xl bg-[#14141A] border border-white/5">
                <p className="font-bold text-white mb-1">2. Créez une nouvelle clé API</p>
                <p className="text-zinc-400">
              ...
              <div className="p-3 rounded-2xl bg-[#14141A] border border-white/5">
                <p className="font-bold text-white mb-1">3. Collez-la dans Gbaigbance</p>
                <p className="text-zinc-400">
            ...
            <div className="pt-2 flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => setShowGuideModal(false)}
                className="py-3 px-4 rounded-2xl bg-white/10 hover:bg-white/15 text-white text-xs font-semibold"
              >
                Fermer
              </button>
            </div>
